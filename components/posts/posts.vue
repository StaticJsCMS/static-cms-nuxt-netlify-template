<template>
  <ul v-if="posts.length > 0" class="w-full py-4 rounded-lg text-left">
    <li
    ...
    >
      <nuxt-link
        ...
        class="flex flex-col justify-between items-start max-w-5xl mx-auto px-4 py-4 rounded border border-solid border-primary card--clickable"
      >
  ...
  <div v-else-if="loading" class="w-full py-4 rounded-lg text-left">
    <div v-for="placeholder in placeholderClasses" :key="placeholder.id" class="flex flex-col justify-between items-start max-w-5xl mx-auto px-4 py-4 rounded border border-solid border-primary">
